 ...
 * Histogram showing distribution of phones across price ranges
 * Helps visualize market segmentation
 */
    ...
    if (active && payload && payload.length) {
      ...
      return (
        <div className="rounded-2xl border border-neutral-200 bg-white px-4 py-3 shadow-lg">
          <p className="text-sm font-semibold text-neutral-950">{range}</p>
    ...
    <div className="rounded-3xl border border-neutral-200 bg-white p-8 shadow-sm">
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm text-neutral-600">
          Market segmentation across price ranges
        </p>
      </div>
